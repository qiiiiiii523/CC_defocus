...
class DGNO_eval(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        if self.train_size and self.grid:
            inp_img = self.grids(inp_img)
        ...
        if self.train_size and self.grid:
            out_dec_level1 = self.grids_inverse(out_dec_level1)
